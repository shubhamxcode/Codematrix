  ...
  return (
    <div className="mt-2">
      <div className="flex justify-between items-center bg-gray-500 shadow-lg rounded-lg max-w-sm mx-auto p-4">
        ...
        <div className="bg-blue-500  text-sm font-medium px-4 py-2 rounded-full">
          {totalcards}
        </div>
      </div>
      <div  className="flex flex-wrap md:justify-start justify-center">
        {displaycards.map((card) => (
          <div key={card.id} className="m-4">
            <Link to={card.to} className="cursor-pointer border border-gray-700 shadow-lg rounded-lg w-72 h-72 sm:w-96 sm:h-96 hover:bg-green-700 hover:shadow-xl m-4  flex flex-col items-center justify-center text-center transition-transform   transform hover:scale-110"
>
            ...
            <div className=" flex justify-center">
              <button
                className="bg-blue-500  font-bold py-2 px-4  rounded hover:bg-blue-700 transition duration-300"
