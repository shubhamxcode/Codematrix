    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Ask me anything and I'll help you find the answer</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-800/50 text-white px-6 py-4 rounded-xl 
        ...
        {answer && (
          <div className="mt-8 relative">
            ...
            <div className="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 shadow-xl">
