...
return (
  ...
  <input 
    ...
    className="w-full md:w-1/2 lg:w-1/3 text-black text-center px-4 py-2 rounded-2xl border-none mb-4 focus:outline-none focus:ring-2 focus:ring-indigo-500" 
  ...
  <div className="w-full md:w-1/2 lg:w-1/3 text-left">
    <pre className="bg-gray-800 p-4 rounded-lg whitespace-pre-wrap break-words">{answer}</pre>
  </div>
</div>
);
}
