...
function Frontend() {
  const cards = [
    { id: 1, title: "HTML", description: "The complete guide for  HTML", },
    ...
    <div className="flex flex-wrap justify-center">
      {cards.map((card) => (
        <Link
          to={card.to}
          key={card.id}
          className="cursor-pointer bg-black border border-gray-700 shadow-lg p-6 rounded-lg hover:bg-green-700 hover:shadow-xl m-4 w-80 h-80 flex flex-col items-center justify-center text-center transition-transform  transform hover:scale-110"
        >
